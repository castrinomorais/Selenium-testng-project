...
public class Testclassthree {
	...
	public void uploadOperation() {
		WebDriver driver;
		driver = new ChromeDriver();
		// To automate process of upload by sending the filepath of the file to be uploaded in the sendkeys
...
//         
	...
	public void hyperLinks() {
		...
		driver = new ChromeDriver();
		driver.navigate()
				.to("https://www.leafground.com/link.xhtml;jsessionid=node010nx464jtc8vzxsmrg4fp0yu9138.node0");
