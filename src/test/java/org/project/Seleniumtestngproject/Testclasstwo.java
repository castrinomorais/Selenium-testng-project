package org.project.Seleniumtestngproject;
...
public class Testclasstwo {
	...
	public void windowHandlesExercisetwo() {
		...
		// parent window contains window handle value of the parent window
		String parentwindow = driver.getWindowHandle();
		...
		// we use size method over the set to count the number of window handles values of the windows opened 
        int numberofwindows = allwindowhandles.size();

		// The value returned by the size method stored in a variable is printed and also all windowhandle values
        //are printed
	...
	public void seleniumRadioButtons() {
		...
		// Status of the radio button safari 
		PageFactory.initElements(driver, PageObjects.class);
